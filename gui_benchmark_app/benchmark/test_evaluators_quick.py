...
async def test_charts_reporter():
    ...
    try:
        ...
        ohi_local.latency = LatencyMetrics(latencies_ms=[80, 95, 88, 102, 85, 92, 98, 105, 90, 94])
        ...
        graph_rag.latency = LatencyMetrics(latencies_ms=[45, 52, 48, 55, 47, 58, 50, 53, 49, 51])
        ...
        vector_rag.latency = LatencyMetrics(latencies_ms=[25, 32, 28, 30, 27, 35, 29, 31, 26, 33])
